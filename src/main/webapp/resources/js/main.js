...
'use strict'
        ...
        var dadoEntrada = $('#dado-entrada').attr("data-numero");
                var dadoSaida = $('#dado-saida').attr("data-numero");
                var dadoEstoque = $('#dado-estoque').attr("data-numero");
                console.log(dadoEntrada);
                console.log(dadoSaida);
                console.log(dadoEstoque);
                //DONUT CHART
                ...
                element: 'sales-chart',
                        ...
                        data: [
                        {label: "ENTRADA", value: dadoEntrada},
                        {label: "SAIDA", value: dadoSaida},
                        {label: "ESTOQUE", value: dadoEstoque}
                        ],
                        options: {
        ...
        CanvasJS.addColorSet("greenShades",
                ...
                backgroundColor: "transparent",
                        ...
                        type: "splineArea",
                                ...
                                {label: "FEV", x: 20, y: 1400},
                                {label: "MAR", x: 30, y: 700},
                                {label: "ABR", x: 40, y: 850},
                                {label: "MAI", x: 50, y: 1350},
                        ...
                        type: "splineArea",
                                ...
                                {label: "FEV", x: 20, y: 800},
                                {label: "MAR", x: 30, y: 1397},
                                {label: "ABR", x: 40, y: 600},
                                {label: "MAI", x: 50, y: 700},
                        ...
                        type: "splineArea",
                                ...
                                {label: "FEV", x: 20, y: 340},
                                {label: "MAR", x: 30, y: 450},
                                {label: "ABR", x: 40, y: 250},
                                {label: "MAI", x: 50, y: 900},
